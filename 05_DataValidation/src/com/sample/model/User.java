...
import com.sample.constraint.Hobbies;
import com.sample.constraint.Sex;
import com.sample.constraint.SqlDatePast;
...
public class User {
	...
	public String toString() {
		return "User2 [id=" + id + ",account=" + account + ", passwd=" + passwd + ", confirmPasswd=" + confirmPasswd
				+ ", sex=" + sex + ", salary=" + salary + ", birthday=" + birthday + ", hobbies="
