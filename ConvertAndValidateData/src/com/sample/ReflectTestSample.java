...
public class ReflectTestSample {
	...
	public static void main(String[] args)
		...
		// 查看类里面声明的变量
		System.out.println(userClass.getName() + " 类里面声明的变量");
		for (Field field : userClass.getDeclaredFields()) {
			System.out.println(field);
		}
		System.out.println(userClass.getName() + " 类里面声明的方法");
		// 查看类里面声明的方法
		...
		Method methodGetTime = dateClass.getMethod("getTime");
		Object ret = methodGetTime.invoke(dateObject);
		if(ret != null) {
			long ms = (long)ret;
